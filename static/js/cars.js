...
document.querySelector('.finish-tasdiqlash').addEventListener('click', async (e) => {
    ...
    async function getVaqt(carModelId, detailId, darajaId) {
        try {
            let res = await fetch("https://expertpro-production.up.railway.app/api/tamirlash-vaqti-yechiladigan/");
     ...
     async function getVaqtYechilmaydigan(carModelId, detailId, darajaId) {
        try {
            let res = await fetch("https://expertpro-production.up.railway.app/api/tamirlash-vaqti-yechilmaydigan/");
            let data = await res.json();
...
//-----------------------------------------------------------Almashtirish uchun UTC----------------------------------------------------------------------------------
      let jamiVaqtAlmashtirishUTC = 0;
        try {
            const res = await fetch(`https://expertpro-production.up.railway.app/api/almashtiriladigan-UTC`);
...
//-----------------------------------------------------------Tamirlash yechiladigan uchun UTC----------------------------------------------------------------------------------
    ...
    async function getCoefficients() {
        try {
            const response = await fetch('https://expertpro-production.up.railway.app/api/tamirlash-yechiladigan-utc/');
            ...
            const response2 = await fetch('https://expertpro-production.up.railway.app/api/tamirlash-yechilmaydigan-utc/');
  ...
  "Том панели"
   ...
   function numberToWords(num) {
        ...
        async function getCoefficient(modelID, KGMK) {
            try {
                const response = await fetch(`https://expertpro-production.up.railway.app/api/kuzov-geometrik-murakkablik-coefitsienti/?car_model=${modelID}&geometrik_murakkablik=${KGMK}`);
                const data = await response.json();
        ...
        const urls = Array.from(slots)
         ...
         async function getShablon() {
            try {
                const response = await fetch(`https://expertpro-production.up.railway.app/api/shablonlar`);
                const data = await response.json();
    ...
    // So‘rov yuborish
    fetch("https://expertpro-production.up.railway.app/generate-word/", {
        method: "POST",
